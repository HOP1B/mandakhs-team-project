    ...
    <footer className="bg-gray-900/80 backdrop-blur-sm py-6 mt-12 relative z-10 border-t border-gray-800">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-bold mb-3 text-gray-300">Connect</h4>
        ...
        <div className="mt-8 pt-6 border-t border-gray-800 text-center text-gray-400 text-sm">
          <p>GunVault © 2025. All rights reserved.</p>
          <p className="mt-2">
            This is a virtual case opening platform. No real gambling involved.
          </p>
        </div>
      </div>
    </footer>
